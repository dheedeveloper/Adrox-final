...
class _LendingHistoryState extends State<LendingHistory> {
  ...
  void apiCall() async {
    final lendingController = Provider.of<LendingHistoryController>(context, listen: false);
    await lendingController.lendingHistoryApiCall(DynamicStrings().token);
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<LendingHistoryController>(
      builder: (context, value, child) => value.isLoading || value.lendingHistoryData==null? DataLoader() : Scaffold(
        body: Container(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Spacer(),
                              Text("${value.lendingHistoryData!.data![index].csqDeposit} ADX",style: TextStyle(color: Colors.black, fontFamily: "Roboto-medium", fontSize: 20.sp,)),
                            ],),
                        ),
                        Padding(
                          padding: EdgeInsets.symmetric(horizontal: 20.w),
                                  ...
                                  children: [
                                    RichText(
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: value.lendingHistoryData!.data![index].daysDuration,
                                            style: TextStyle(
                                              color: Colors.black,
                                    ...
                                    RichText(
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text: value.lendingHistoryData!.data![index].profit, // Top text with smaller font size
                                            style: TextStyle(
                                              color: Colors.black,
                                              fontWeight: FontWeight.bold,
                                              fontFamily: "Roboto-regular",
                              ...
                              RichText(
                                text: TextSpan(
                                  children: [
                                    ...
                                    TextSpan(
                                      text: value.lendingHistoryData!.data![index].hashId, // Bottom text with larger font size
                                      style: TextStyle(
                          ...
                          child: RichText(
                            text: TextSpan(
                              children: [
                                ...
                                TextSpan(
                                  text: value.lendingHistoryData!.data![index].matureDate.toString(), // Bottom text with larger font size
                                  style: TextStyle(
                                    color: Colors.black,
                                    fontFamily: "Roboto-medium",
                                    fontSize: 13.sp, // Larger font size

          ...
          children: [
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Text(value.rightPoolData!.data!.lending!.totalpool.toString(),style: TextStyle(color: Color(0xff41418E), fontFamily: "Roboto-regular", fontSize: 18.sp,)),
                    ],),
                  SizedBox(width: 5.w,),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(value.rightPoolData!.data!.lending!.totalmembers.toString(),style: TextStyle(color: Color(0xff41418E), fontFamily: "Roboto-regular", fontSize: 18.sp,)),
                    ],),
                ],
              ),),
            ...
            Expanded(
              child: ListView.builder(
                itemCount: value.rightPoolData!.data!.history!.length,
                        ...
                        Row(
                          ...
                          children: [
                            Column(
                              ...
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(value.rightPoolData!.data!.history![index].amount.toString(),style: TextStyle(color: Colors.black, fontFamily: "Roboto-regular", fontSize: 14.sp,)),
                                Text(value.rightPoolData!.data!.history![index].sponsorUsername.toString(),style: TextStyle(color: Colors.black, fontFamily: "Roboto-regular", fontSize: 10.sp,)),
                              ],),
                            Spacer(),
                            Container(
                              height: 30.h,width: 100.h,decoration: BoxDecoration(color: Color(0xff212743),
                                borderRadius: BorderRadius.circular(10.r)),
                              child: Center(child: Text(value.rightPoolData!.data!.history![index].referralId.toString(),style: TextStyle(color: Colors.white, fontFamily: "Roboto-regular", fontSize: 12.sp,))),),
                            SizedBox(width: 16.w,),
                            Text(value.rightPoolData!.data!.history![index].time.toString().split(" ").first,style: TextStyle(color: Colors.black54, fontFamily: "Roboto-regular", fontSize: 12.sp,)),
                          ],),
                      ],),),
                ),
              ),
